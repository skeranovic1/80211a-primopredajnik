...
def packet_detector(rx_input):
    """
    Detektuje početak paketa u primljenom OFDM signalu koristeći autokorelaciju.

    Funkcija koristi 16-uzoraka kašnjenje i pomični prozor od 32 uzorka
    za procjenu autokorelacije i varijanse signala. Na osnovu odnosa
    autokorelacije i varijanse ('comparison_ratio') detektuje prisustvo paketa
    sa histerezom, te pronalazi indeks padajuće ivice STS-a (falling edge).
    ...
    Povratna vrijednost
    comparison_ratio : ndarray
        Odnos apsolutne autokorelacije i varijanse, korišten za detekciju paketa.
    packet_det_flag : ndarray
        Binarna zastavica koja označava prisustvo paketa (1) ili odsustvo (0).
    falling_edge_position : int ili None
        Indeks gdje signal prelazi iz stanja "paket prisutan" u "paket nije prisutan".
